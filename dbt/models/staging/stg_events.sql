SELECT
    ...
    SAFE_CAST(JSON_VALUE(event_json, '$.shot.technique.name') AS INT64) AS technique_name,
    SAFE_CAST(JSON_VALUE(event_json, '$.shot.type.id') AS INT64) AS shot_type_id,
    SAFE_CAST(JSON_VALUE(event_json, '$.shot.type.name') AS INT64) AS shot_type_name,
